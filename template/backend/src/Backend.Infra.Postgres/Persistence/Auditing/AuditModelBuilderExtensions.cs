...
public static class AuditModelBuilderExtensions
{
    ...
    public static ModelBuilder ApplyMandatoryAuditing(this ModelBuilder modelBuilder)
    {
        ...
        {
            ConfigureTable(table.Key, table);
        }
    ...
    private static void ConfigureTable(PhysicalTable table, IEnumerable<IMutableEntityType> mappings)
    {
        ...
        ConfigureIncrementalIndex(owner, table);
    }
    ...
    private static void ConfigureIncrementalIndex(IMutableEntityType owner, PhysicalTable table)
    {
        ...
        IndexBuilder index = new EntityTypeBuilder(owner).HasIndex(propertyNames);
        ...
        Type contract)
    {
        ...
        IKey primaryKey = parent.FindPrimaryKey()
